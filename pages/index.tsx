...
function HomePage() {
  ...
  const navigation = [
    ...
    { title: "Comprar por marca", path: "javascript:void(0)" },
    { title: "Comprar por mascota", path: "javascript:void(0)" },
    { title: "Nuestros servicios", path: "javascript:void(0)" },
    { title: "Promociones", path: "javascript:void(0)" },
    { title: "Nosotros", path: "javascript:void(0)" }
  ]
  useEffect(() => {
    if (navRef.current) {
  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-between mx-auto px-4'>
        <a className='ml-4' href="javascript:void(0)">
          <img
            src="/logomaxi.png"
            width={169.46}
            height={46}
        ...
        <div className='flex items-center justify-center flex-1 '>
          <form className="flex items-center space-x-2 p-2 max-w-3xl ">
            <div className="relative flex w-full py-2">
              <input
                className="w-[320px] h-[33px] py-2 rounded-lg border border-gray-400 placeholder-gray-300 text-sm focus:outline-none "
                type="text"
      ...
      <nav ref={navRef} className="bg-white drop-shadow-lg relative  z-20  w-full top-0 items-center justify-center">
        <div className="items-center  max-w-screen-xl mx-auto md:px-8 lg:flex">
          ...
          <div className="items-center content-center justify-center mx-auto">
            <ul className="justify-center items-center space-y-8 lg:flex gap-24 lg:space-y-0 ">
              {
                navigation.map((item, idx) => {
                  return (
                    <li key={idx} className="text-gray-600 hover:text-primary-300 sm:text-sm md:text-sm lg:text-sm xl:text-md">
                      <a href={item.path}>
                        {item.title}
                      </a>
                    </li>
