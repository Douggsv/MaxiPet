    ...
    >
      <div className='flex flex-col '>
        <div className=" bg-gray-100 drop-shadow-lg rounded-lg px-10 z-900 sm:w-[21.25rem] md:w-[40.25rem] lg:w-[46.25rem] xl:w-[46.25rem] py-10" >
          <p className=" sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl font-bold  text-center flex justify-center">Bienvenid@ a mi prueba técnica para AvilaTek</p>
          <p className="sm:text-sm md:text-lg lg:text-xl xl:text-xl text-center justify-center py-2 mb-2">Desarrollado por Douglas Marquez 👩‍💻</p>
