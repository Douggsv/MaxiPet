      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 py-10">
          ...
          <div className="mb-4">
            ...
            <p className="list-none text-sm text-secondary-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mus molestie rhoncus id nunc, porta leo tempus facilisi.</p>
          </div>
          ...
          <div className="mb-4">
            <h4 className="font-bold mb-4 text-primary-300">Atencion al cliente</h4>
            <ul className="list-none text-sm text-secondary-500">
        ...
        <div className="bg-primary-300 text-white py-3 text-center bottom-0 mt-10 relative">
          ...
          <div className="container mx-auto flex justify-center items-center">
            <p className="text-sm flex items-center">
              ...
              <img className='ml-1 sm:w-3 sm:h-2 md:w-4 md:h-4 lg:w-5 lg:h-4 xl:w-5 xl:h-4' src="/path0.png" alt="" />
            </p>
          </div>
        </div>
      </div>
